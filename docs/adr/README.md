...
| [0003](./0003-issue-field-concurrency.md)                      | Issue field concurrency via expected-value CAS and description hash | Proposed |
| [0004](./0004-async-issue-csv-export.md)                       | Async issue CSV export                                              | Proposed |
